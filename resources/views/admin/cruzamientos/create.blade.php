...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#tachoPadre").change(function(){
            ...
            $.get('/mejoramiento/public/tallosTacho/'+id, function(data){
        ...
        if (tachoValue != "") {
            ...
            if (existeTallo) {
                ...
                if (!existeTacho) {
                    ...
                    let myTable= "<table><tr><td style='width: 100px; font-weight: bold; color:blue;'>Tacho: "+ tachoText + "</td></tr>";
                    for (let j = 0; j < tallospadre.length; j++) {
                        if(tallospadre[j].tacho == tachoText) {
                            ...
                            myTable+="<tr><td style='width: 100px;text-align: center;'>" + tallospadre[j].valor + " Polen: " + polenTallo + " </td> </tr>"; 
                        }   
                    }
                    myTable+="</table>";
                ...
                if (!existeTacho) {
                    ...
                    for (let i = 0; i < tallosmadre.length; i++) {
                        if(tallosmadre[i].tacho == tachoText) {
                            ...
                            myTable+="<tr><td style='width: 100px;text-align: center;'>" + tallosmadre[i].valor + " Polen: " + polenTallo + " </td> </tr>";         
                        }   
                    }
                    myTable+="</table>";
                    div.innerHTML = myTable;
...
<div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="form-group">
                <label for="tipocruzamiento">Padre</label>
                    <select name="tachoPadre" id="tachoPadre" class="select2" style="width: 100%;" class="form-control" required>
    ...
    <div>
        <div id="cruzamientosPadre" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    </div>
    ...
    <div id="madres">
        <table style="width: 100%;">
                ...
                <tbody>
                    ...
                    <td id="cruza" style="width: 33%;">
                        <select name="tachoMadre" id="tachoMadre" class="select2" style="width: 30%;" class="form-control" required>
                        ...
                        <br>
                        <div class="form-inline">
                            <select id="talloMadre" name="talloMadre" class="select2" style="width: 10%;" >
                                <option value=""> Tallo </option>
                            </select>
                            &nbsp;
    ...
    <div>
        <div id="cruzamientos" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
    </div>    
