                        ...
                        <tbody>
                            ...
                            @foreach ($parcelasPC as $auxParcela)
                                ...
                                @if (!$parcela->testigo)
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" class="form-check-input check-seleccionado"
                                                value="{{ $parcela->id }}" name="seedlingsPC[]"
                                                data-segundas="{{ $parcela->segundas()->with('segunda')->get() }}"
                                                data-laboratorio="{{ $parcela->laboratorio }}"
                    ...
                    <tbody>
                        @foreach ($testigos as $testigo)
                            <tr>
                                ...
                                <td><button class='btn deleteBtn' data-id="{{ $testigo->id }}"><i
