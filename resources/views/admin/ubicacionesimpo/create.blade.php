...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Nueva ubicación para importación</h3>
			@if (count($errors)>0)
	...
	{!!Form::open(array('url'=>'admin/ubicacionesimpo','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
    <input type="hidden" name="area" id="area" value="impo">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
