...
@section('titulo', 'Editar Evaluación Agronómica')
@section('content')
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Editar Evaluación Agronómica </h3>
			@if (count($errors)>0)
    ...
    {!!Form::model($agronomica,['method'=>'PATCH','name'=>'fagronomica','route'=>['agronomicas.update',$agronomica->idagronomica]])!!}
    {{Form::token()}}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <select name="idbanco" id="idbanco" class="form-control">
                 <option value="{{$agronomica->idbanco}}" >{{$agronomica->nombrebanco}}</option>
              </select>
         </div>
        </div>
    </div>
                ...
                <label for="nombre">Nombre de la evaluación</label>
                    <select name="idnombre" id="idnombre" class="select2" style="width: 100%;" class="form-control" required>
                        ...
                        @foreach ($tipos as $tipo)
                            <option value="{{$tipo->id}}" {{ $tipo->id == $agronomica->idnombre ? 'selected="selected"' : '' }}>{{$tipo->nombre}}</option>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <input class="form-control" name="fechageneracion" id="fechageneracion" type="date" value="{{$agronomica->fechageneracion}}">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <textarea  maxlength="1000" name="observaciones" id="observaciones" class="form-control">{{$agronomica->observaciones}}</textarea>
            </div>  
        </div>
    </div>
    <div class="row">
