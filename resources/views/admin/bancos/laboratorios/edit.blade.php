...
@section('titulo', 'Editar Evaluación de laboratorio')
@section('content')
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Editar Evaluación de laboratorio </h3>
			@if (count($errors)>0)
    ...
    {!!Form::model($laboratorio,['method'=>'PATCH','name'=>'flaboratorio','route'=>['laboratorios.update',$laboratorio->idlaboratorio]])!!}
    {{Form::token()}}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <select name="idbanco" id="idbanco" class="form-control">
                 <option value="{{$laboratorio->idbanco}}" >{{$laboratorio->nombrebanco}}</option>
              </select>
         </div>
        </div>
    </div>
                ...
                <label for="nombre">Nombre de la evaluación</label>
                    <select name="idnombre" id="idnombre" class="select2" style="width: 100%;" class="form-control" required>
                        ...
                        @foreach ($tipos as $tipo)
                            <option value="{{$tipo->id}}" {{ $tipo->id == $laboratorio->idnombre ? 'selected="selected"' : '' }}>{{$tipo->nombre}}</option>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <input class="form-control" name="fechageneracion" id="fechageneracion" type="date" value="{{$laboratorio->fechageneracion}}">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <textarea  maxlength="1000" name="observaciones" id="observaciones" class="form-control">{{$laboratorio->observaciones}}</textarea>
            </div>  
        </div>
    </div>
    <div class="row">
