...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<h3>Evaluaciones realizadas sobre la ubicación: <b>{{$ubicacion[0]->nombreubicacion}}</b>.</h3>
	</div>
</div>
<div class="container">
    <div class="row">
    ...
    <legend>Tachos en la ubicación {{$ubicacion[0]->nombreubicacion}}:</legend>
   	...
   	<fieldset style="border-width: 1px; border-style: solid; border-color: #337ab7; padding: 15px">
	<legend>Registrar Evaluaciones a los tachos de un Box</legend>
	<div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="numtextber" name="altura" id="altura" class="form-control">
                    </div>
                </div>
