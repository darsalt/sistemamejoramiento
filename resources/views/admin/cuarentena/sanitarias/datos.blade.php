...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<h3>Datos de la evaluación N°: <b>{{$sanitaria->id}}</b> - Campaña: <b>{{$sanitaria->campania->nombre}}</b></h3>
	</div>
</div>
...
<script type="text/javascript">
  ...
  function guardaevaluacion(id) {
    ...
    $.ajax({
      type: 'POST',
      url:"{{ route('cuarentena.sanitarias.storeDatosAsociados') }}",
    ...
    function load_more(page){
        $.ajax({
           url: SITEURL + "/admin/cuarentena/sanitarias/datosasociados/"+idevaluacion+"?page=" + page,
