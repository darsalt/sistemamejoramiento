...
@section('titulo', 'Registrar nueva tarea de corte')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>Nueva tarea de corte</h3>
            @if (count($errors)>0)
    ...
    <form action="{{route('cuarentena.generales.corte.store')}}" method="POST" autocomplete="off">
        @csrf
