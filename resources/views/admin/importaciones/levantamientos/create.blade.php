...
@section('titulo', 'Registrar levantamiento de cuarentena')
@section('content')
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Nuevo levantamiento de cuarentena</h3>
			@if (count($errors)>0)
    ...
    <section class="content">
        <form action="{{route('importaciones.levantamientos.store')}}" id="formInspeccion" method='POST' enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label for="fecha">Fecha levantamiento</label>
