    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input class="form-control" name="poder" step="0.01" id="poder" type="number" placeholder="Poder Germinativo..." required="required">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label for="stock">Stock</label>
                <input type="number" name="stock" step="0.01" class="form-control" placeholder="Stock Inicial..."  required="required">
            </div>
        </div>
    </div>    
    <div class="row">
