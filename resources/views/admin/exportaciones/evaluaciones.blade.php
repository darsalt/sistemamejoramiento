...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<h3>Evaluaciones realizadas sobre la variedad <b>{{$exportacion[0]->nombrevariedad}}</b> en el tacho <b>{{$exportacion[0]->codigo}}-{{$exportacion[0]->subcodigo}}</b>, ubicado en el Box <b>{{$exportacion[0]->idubicacion}}</b>.</h3>
	</div>
</div>
<div class="container">
    <div class="row">
	...
	<div class="panel-body">
	    ...
	    <input type="hidden" value="{{$exportacion[0]->idvariedad}}" id="idvariedad" name="idvariedad">
			<input type="hidden" value="{{$exportacion[0]->idtacho}}" id="idtacho" name="idtacho">
		<input type="hidden" value="{{$exportacion[0]->idubicacion}}" id="idubicacion" name="idubicacion">
