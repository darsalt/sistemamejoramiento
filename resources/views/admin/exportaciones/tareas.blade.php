...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<h3>Tareas realizadas sobre la variedad <b>{{$exportacion[0]->nombrevariedad}}</b> en el tacho <b>{{$exportacion[0]->codigo}}-{{$exportacion[0]->subcodigo}}</b>, ubicado en el Box <b>{{$exportacion[0]->idubicacion}}</b>.</h3>
	</div>
</div>
<div class="container">
    <div class="row">
