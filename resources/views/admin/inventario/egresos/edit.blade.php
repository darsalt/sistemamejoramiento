...
<div class="container">
    ...
    <form action="{{route('inventario.egresos.update', $egreso->id)}}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
        ...
        <div class="form-group" style="text-align:center;">
            ...
            <select name="campania" id="campania" class="select2" style="width: 100%; " class="form-control" required>
                ...
                @foreach ($campanias as $campania)
                    @if ($egreso->idcampania == $campania->id)
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="madre" id="madre" class="form-control" placeholder="Madre..." value="{{old('madre', $egreso->madre)}}" readonly>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    <label for="padre">Padre</label>
                    <input type="text" name="padre" id="padre" class="form-control" placeholder="Padre..." value="{{old('madre', $egreso->padre)}}" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="cantidad" step="0.01" class="form-control" placeholder="Cantidad a ajustar..." value="{{old('cantidad', $egreso->cantidad)}}" required="required">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input class="form-control" name="fechaegreso" id="fechaegreso" type="date" value="{{old('fechaegreso', $egreso->fecha_egreso)}}" required="required">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <textarea  maxlength="1000" name="observaciones" id="observaciones" class="form-control" placeholder="Ingrese observaciones">{{old('observaciones', $egreso->observaciones)}}</textarea>
                </div>  
            </div>
        </div>
